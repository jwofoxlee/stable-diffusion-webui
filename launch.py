...
#latent_diffusion_commit_hash = os.environ.get('LATENT_DIFFUSION_COMMIT_HASH', "a506df5756472e2ebaf9078affdde2c4f1502cd4")
latent_diffusion_commit_hash = os.environ.get('LATENT_DIFFUSION_COMMIT_HASH', "abf33e7002d59d9085081bce93ec798dcabd49af")
...
#git_clone("https://github.com/CompVis/latent-diffusion.git", repo_dir('latent-diffusion'), "Latent-diffusion", latent_diffusion_commit_hash)
